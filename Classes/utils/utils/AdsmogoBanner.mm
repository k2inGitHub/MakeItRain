...
void AdsmogoBanner::createBanner(const char * mogoid,AdsmogoBannerType type,float x, float y,bool  ismanualrefresh) {
...
void AdsmogoBanner::createBanner(const char * mogoid,AdsmogoBannerType type, AdMoGoPointType  pointType,bool  ismanualrefresh) {
    NSString *mogo_id = [[NSString alloc] initWithCString:mogoid
                                                 encoding:NSASCIIStringEncoding];
    //Set the advertising types
    AdViewType mogotype=(AdViewType)type;
