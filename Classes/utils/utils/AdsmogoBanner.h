...
public:
    ...
    /**
     ...
     y  广告位置Y坐标
     */
    void createBanner(const char* mogoid,AdsmogoBannerType type,float x, float y,bool ismanualrefresh);
     ...
     */
    void createBanner(const char * mogoid,AdsmogoBannerType type, AdMoGoPointType  pointType,bool  ismanualrefresh);
